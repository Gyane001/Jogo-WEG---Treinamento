...
Sistema de Diálogos Dinâmicos: Integração com Ink.Runtime para suporte a escolhas, variáveis e ramificações narrativas.

- Gerenciador de Áudio Persistente: Sistema de áudio que utiliza o padrão Singleton para garantir que a trilha sonora não seja interrompida durante a transição entre fases.
